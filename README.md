...
- **Spin-polarised support**: separate spin-up/down channels with mirror plotting
...
- Python >= 3.10
- pymatgen >= 2024.1, PySide6 >= 6.5, matplotlib >= 3.7, numpy
...
differ from VASPKIT `--task 11x` width output.
...
python tests/verify_e2e_correctness.py    # end-to-end on real VASP data
```
